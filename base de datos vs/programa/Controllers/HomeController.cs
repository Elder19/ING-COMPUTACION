...
namespace tarea001.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string directoryPath =  @"C:\Users\coleg\OneDrive\Documentos\GitHub\ING-COMPUTACION\base de datos vs\programa\wwwroot\JSON" ;
            string filePath = Path.Combine(directoryPath, "datos.json");//agrega el nombre del archivo a la ruta
        ...
        */
        ...
        {   //si los datos no son nulos 
            ...
            try
            {
                // Ruta para el directorio donde se guardará el archivo JSON C:\Users\coleg\OneDrive\Escritorio\base de datos vs\tarea001
                string directoryPath = @"C:\Users\coleg\OneDrive\Documentos\GitHub\ING-COMPUTACION\base de datos vs\programa\wwwroot\JSON";
